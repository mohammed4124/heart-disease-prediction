...
comboboxvalues={"Homme":1,"Femme":0,"Angine typique": 0, "Angine atypique": 1, "Douleur non angineuse": 2,
                "Asymptomatique":3, "Normal": 0, "Anomalie de ST-T": 1, "Hypertrophie ventriculaire gauche": 2,
                "Non": 0, "Oui": 1, "Montant": 'Up',
                "Plat": 'Flat', "Descendant": 'Down'}
echontillon=[]


def check_type(i, t):
    j = ["Age", "Sex", "Douleur thoracique", "Tension artérielle", "Cholestérol", "Glycémie à jeun", "ECG",
         "Fréquence cardiaque max", "Angine par l'effort", "Dépression ST", "Pente du segment ST"]
    if i in [1, 2, 6, 8, 10]:
